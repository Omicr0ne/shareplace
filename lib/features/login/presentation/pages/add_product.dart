								...
								child: Column(
									...
									children: [
										...
										_TextFieldSection(
											...
											hintText: 'Produit',
											validator: (value) => value == null || value.trim().isEmpty ? 'Nom du produit requis' : null,
										),
										...
										_TextFieldSection(
											...
											maxLines: 4,
											validator: (value) => value == null || value.trim().isEmpty ? 'Description requise' : null,
										),
										const SizedBox(height: 10),
										_TextFieldSection(
										...
										DropdownButtonFormField<String>(
											...
											validator: (value) => value == null && _tags.isEmpty ? 'Tag requis' : null,
										),
